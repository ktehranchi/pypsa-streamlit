...
st.sidebar.write("Upload or specify a PyPSA network file to explore its components and data.")
...
if network is not None:
    ...
    **PyPSA (Python for Power System Analysis)** is a free software toolbox for simulating and optimizing modern power systems that include features such as:
    ...
    1. Use the sidebar to select how you want to load a network
    2. Upload a PyPSA network file (.nc format) or specify a file path
    3. Alternatively, load a sample network to explore the app's features
    """)
